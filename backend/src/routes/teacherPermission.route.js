...
router.get("/:teacherId/permissions", getTeacherPermissionsController, isAdmin);

// Solo un admin puede dar/quitar permisos a profesores, implementar el middleware
router.post("/:teacherId/permissions", assignPermissionController, isAdmin);

router.delete("/:teacherId/permissions", revokePermissionController, isAdmin);
